...
const userSchema = new mongoose.Schema({
    ...
    ds_email: {
        ...
        trim: true,
        lowercase: true,
        validate: [validator.isEmail, 'Plase prxovide a valid email']
    },
    ds_gender: {
        type: Number,
        default: 0,
    ...
    ds_avatar: {    // customer avatar
        type: String,
        default: 'avatar1.png'
    },
    ds_avatar1: {   // researcher avatar
        type: String,
        default: 'avatar1.png'
    },
    ds_password: {
    ...
    account_cancellation: {
        id_accountcancellationtype: {
            type: Schema.Types.ObjectId, ref: "account_cancellation_types"
        },
    ...
    about_me: {
        ...
        languages: [{
            ...
            id_languageproficiency: {type: Schema.Types.ObjectId, ref: "language_proficiencies"}
        }],
        specialities:[{
            type: Schema.Types.ObjectId, ref: "specialities",
        }]
    },
    ic_currentplan: {
        type: Number,
