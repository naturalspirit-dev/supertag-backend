...
router.post('/setnotificatoinsetting', auth, userController.setnotificationsetting);
...
router.get('/getreviewofresearcher', auth, userController.getprofileofresearcher);
